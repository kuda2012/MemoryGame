...
for( i = 0; i < randomNumber; i++){
  ...
  COLORS[i] ={["color" + (i)]: `rgb(${(Math.floor(Math.random()*256), Math.floor(Math.random()*256),Math.floor(Math.random()*256))},${(Math.floor(Math.random()*256), Math.floor(Math.random()*256),Math.floor(Math.random()*256))},${(Math.floor(Math.random()*256), Math.floor(Math.random()*256),Math.floor(Math.random()*256))})`
...
function theRemoval(){
    ...
    initalScoreLabel.innerText = initalScoreLabel.innerText.concat(" ").concat(`${intialScore}`)
    ...
    bestScoreLabel.innerText = bestScoreLabel.innerText.concat(" ").concat(localStorage.getItem('score'))
